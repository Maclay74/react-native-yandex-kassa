...
/*!
 ...
 @constant THMStatusCodeNotConfigured            configure has not been called or failed.
 @constant THMStatusCodeCertificateMismatch      Certificate hash or public key hash provided does not match with the server certificate.
